...
class ForeGroundService : Service()  {
    ...
    override fun onStartCommand(intent: Intent, flags: Int, startId: Int): Int {
        val btnOkClicked = Intent(this, ButtonClickReceiver::class.java)
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            notifBuilder = NotificationCompat.Builder(this, createNotificationChannel(this, NotificationManager.IMPORTANCE_HIGH)
                    ?: "")
        } else {
